...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.seo-head','data' => ['seo' => $seoData,'schema' => $schema ?? null,'post' => $post ?? null]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['seo' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($seoData),'schema' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($schema ?? null),'post' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($post ?? null)]); ?>
...
<?php endif; ?>
    ...
    <?php if($gaTrackingId): ?>
        ...
        <script>
            ...
            gtag('config', '<?php echo e($gaTrackingId); ?>', {
                'anonymize_ip': true,
                'page_title': <?php echo json_encode(html_entity_decode($seoData['title'] ?? 'LokSewaAlert')); ?>,
    ...
    <link rel="preload" as="image" href="<?php echo e(asset('images/jobone-logo.png')); ?>" fetchpriority="high">
        ...
        <nav class="w-full px-2 sm:px-4 lg:px-6 py-1 md:py-2">
            <div class="flex justify-between items-center gap-2">
                ...
                <a href="<?php echo e(route('home')); ?>"
                    ...
                    <img src="<?php echo e(asset('images/jobone-logo.png')); ?>" alt="LokSewaAlert - Nepal Government Jobs Portal"
...
<?php endif; ?>
    ...
    <div class="fixed top-1/2 transform -translate-y-1/2 z-40 flex flex-col gap-2 md:gap-4 drop-shadow-lg"
         style="right:0;">
        <!-- WhatsApp Button -->
        <a href="<?php echo e(\App\Models\SiteSetting::where('key', 'whatsapp_channel')->value('value') ?: 'https://whatsapp.com/channel/0029VbD9cau2P59hFZ1nwh22'); ?>" target="_blank" rel="noopener noreferrer"
        ...
        <!-- Telegram Button -->
        <a href="<?php echo e(\App\Models\SiteSetting::where('key', 'telegram_url')->value('value') ?: 'https://t.me/loksewaalert'); ?>" target="_blank" rel="noopener noreferrer"
            class="flex items-center justify-center md:w-14 md:h-14 text-white shadow-2xl transition-all duration-300 hover:scale-110"
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-8">
                ...
                <div>
                    ...
                    <div class="flex gap-3 mt-4">
                        <a href="<?php echo e(\App\Models\SiteSetting::where('key', 'telegram_url')->value('value') ?: 'https://t.me/loksewaalert'); ?>" target="_blank"
                        ...
                        <a href="<?php echo e(\App\Models\SiteSetting::where('key', 'whatsapp_channel')->value('value') ?: 'https://whatsapp.com/channel/0029VbD9cau2P59hFZ1nwh22'); ?>" target="_blank"
...
<?php /**PATH C:\xampp\htdocs\job\loksewaalert-portal\resources\views/layouts/app.blade.php ENDPATH**/ ?>