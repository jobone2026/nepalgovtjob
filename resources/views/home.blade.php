...
@section('title', 'LokSewaAlert – लोकसेवा सुचना ' . date('Y') . ', Nepal Government Jobs')
@section('description', 'LokSewaAlert – Nepal\'s fastest-updated लोकसेवा सुचना portal. Today\'s govt job vacancies, exam results, admit cards, answer keys & syllabus.')
